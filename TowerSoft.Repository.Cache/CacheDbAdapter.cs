...
namespace TowerSoft.Repository.Cache {
    ...
    public class CacheDbAdapter : DbAdapter, IDbAdapter {
        ...
        /// <summary>
        /// Returns a limit and offset statement for the current database type. LIMIT and OFFSET are not supported in Caché
        /// </summary>
        ...
        public override string GetLimitOffsetStatement(int? limit, int? offset, QueryBuilder query) {
            throw new NotSupportedException("LIMIT and OFFSET statements are not supported in Intersystems Caché");
        }
    }
}
